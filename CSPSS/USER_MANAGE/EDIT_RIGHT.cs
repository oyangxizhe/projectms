...
namespace CSPSS.USER_MANAGE
{
    public partial class EDIT_RIGHT : Form
    {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        ...
                        if (dr1["NODE_NAME"].ToString() == dr["作业名称"].ToString())
                        {
                            if (dr1["NODE_NAME"].ToString() == "纸品报价新增" || dr1["NODE_NAME"].ToString() == "打样单新增" ||
                                ...
                                || dr1["NODE_NAME"].ToString() == "生产指示书"
                                  || dr1["NODE_NAME"].ToString() == "库存维护"
                                  || dr1["NODE_NAME"].ToString() == "开票维护"
                                  || dr1["NODE_NAME"].ToString() == "收款维护"
                                )
                            {
        ...
        private void dgvStateControl_control_if_readonly(DataGridView dgv)
        {
            ...
            {
                dgv.Rows[i].Cells["样板审核"].ReadOnly = true;//实际控件DGV 复选框是否可点击161026
                dgv.Rows[i].Cells["图片上传"].ReadOnly = true;
                dgv.Rows[i].Cells["纸品签核"].ReadOnly = true;
                dgv.Rows[i].Cells["亚克力签核"].ReadOnly = true;
                dgv.Rows[i].Cells["木铁签核"].ReadOnly = true;
                dgv.Rows[i].Cells["采购签核"].ReadOnly = true;
                dgv.Rows[i].Cells["样板审核"].Style.BackColor = c1;
                dgv.Rows[i].Cells["图片上传"].Style.BackColor = c1;
                dgv.Rows[i].Cells["纸品签核"].Style.BackColor = c1;
                dgv.Rows[i].Cells["亚克力签核"].Style.BackColor = c1;
                dgv.Rows[i].Cells["木铁签核"].Style.BackColor = c1;
                dgv.Rows[i].Cells["采购签核"].Style.BackColor = c1;
                dgv.Rows[i].Cells["报价审核"].ReadOnly = true;
                dgv.Rows[i].Cells["报价日期查询"].ReadOnly = true;
                dgv.Rows[i].Cells["基本信息_采购"].ReadOnly = true;
                dgv.Rows[i].Cells["估计计算表"].ReadOnly = true;
                dgv.Rows[i].Cells["预算明细表"].ReadOnly = true;
                dgv.Rows[i].Cells["基本信息_AE"].ReadOnly = true;
                dgv.Rows[i].Cells["主件明细表"].ReadOnly = true;
                dgv.Rows[i].Cells["产品报价单"].ReadOnly = true;
                dgv.Rows[i].Cells["明细报价单"].ReadOnly = true;
                dgv.Rows[i].Cells["报价审核"].Style.BackColor = c1;
                dgv.Rows[i].Cells["报价日期查询"].Style.BackColor = c1;
                dgv.Rows[i].Cells["基本信息_采购"].Style.BackColor = c1;
                dgv.Rows[i].Cells["估计计算表"].Style.BackColor = c1;
                dgv.Rows[i].Cells["预算明细表"].Style.BackColor = c1;
                dgv.Rows[i].Cells["基本信息_AE"].Style.BackColor = c1;
                dgv.Rows[i].Cells["主件明细表"].Style.BackColor = c1;
                dgv.Rows[i].Cells["产品报价单"].Style.BackColor = c1;
                dgv.Rows[i].Cells["明细报价单"].Style.BackColor = c1;
                if (dgv["作业名称", i].FormattedValue.ToString() == "纸品报价新增" ||
                    dgv["作业名称", i].FormattedValue.ToString() == "打样单新增" ||
                    dgv["作业名称", i].FormattedValue.ToString() == "项目新增"
                    || dgv["作业名称", i].FormattedValue.ToString() == "生产指示书"
                    || dgv["作业名称", i].FormattedValue.ToString() == "库存维护"
                    || dgv["作业名称", i].FormattedValue.ToString() == "开票维护"
                    || dgv["作业名称", i].FormattedValue.ToString() == "收款维护"
                    )
                {
                    ...
                    if (dgv["作业名称", i].FormattedValue.ToString() == "纸品报价新增")
                    {
                        dgv.Rows[i].Cells["报价审核"].ReadOnly = false;
                        dgv.Rows[i].Cells["报价日期查询"].ReadOnly = false;
                        dgv.Rows[i].Cells["基本信息_采购"].ReadOnly = false;
                        dgv.Rows[i].Cells["估计计算表"].ReadOnly = false;
                        dgv.Rows[i].Cells["预算明细表"].ReadOnly = false;
                        dgv.Rows[i].Cells["基本信息_AE"].ReadOnly = false;
                        dgv.Rows[i].Cells["主件明细表"].ReadOnly = false;
                        dgv.Rows[i].Cells["产品报价单"].ReadOnly = false;
                        dgv.Rows[i].Cells["明细报价单"].ReadOnly = false;

                        dgv.Rows[i].Cells["报价审核"].Style.BackColor = Color.White;
                        dgv.Rows[i].Cells["报价日期查询"].Style.BackColor = Color.White;
                        dgv.Rows[i].Cells["基本信息_采购"].Style.BackColor = Color.White;
                        dgv.Rows[i].Cells["估计计算表"].Style.BackColor = Color.White;
                        dgv.Rows[i].Cells["预算明细表"].Style.BackColor = Color.White;
                        dgv.Rows[i].Cells["基本信息_AE"].Style.BackColor = Color.White;
                        dgv.Rows[i].Cells["主件明细表"].Style.BackColor = Color.White;
                        dgv.Rows[i].Cells["产品报价单"].Style.BackColor = Color.White;
                        dgv.Rows[i].Cells["明细报价单"].Style.BackColor = Color.White;

                    }
                    if (dgv["作业名称", i].FormattedValue.ToString() == "打样单新增"
                        )
                    {
                        dgv.Rows[i].Cells["样板审核"].ReadOnly = false;
                        dgv.Rows[i].Cells["图片上传"].ReadOnly = false;
                        dgv.Rows[i].Cells["纸品签核"].ReadOnly = false;
                        dgv.Rows[i].Cells["亚克力签核"].ReadOnly = false;
                        dgv.Rows[i].Cells["木铁签核"].ReadOnly = false;
                        dgv.Rows[i].Cells["采购签核"].ReadOnly = false;

                        dgv.Rows[i].Cells["样板审核"].Style.BackColor = Color.White;
                        dgv.Rows[i].Cells["图片上传"].Style.BackColor = Color.White;
                        dgv.Rows[i].Cells["纸品签核"].Style.BackColor = Color.White;
                        dgv.Rows[i].Cells["亚克力签核"].Style.BackColor = Color.White;
                        dgv.Rows[i].Cells["木铁签核"].Style.BackColor = Color.White;
                        dgv.Rows[i].Cells["采购签核"].Style.BackColor = Color.White;

                    }
                    if (dgv["作业名称", i].FormattedValue.ToString() == "项目新增")
                    {
                        dgv.Rows[i].Cells["删除"].ReadOnly = true;//160118 项目不允许删除，所以不用删除权限
                        dgv.Rows[i].Cells["删除"].Style.BackColor = c1;//160118 项目不允许删除，所以不用删除权限
                    }
                }
                else
                {
        ...
        private int return_Voucher_rows(DataTable dt)
        {
            ...
            for (i = 0; i <dt.Rows .Count ; i++)
            {
                if (dt.Rows[i]["作业名称"].ToString() == "纸品报价新增" || dt.Rows[i]["作业名称"].ToString() == "打样单新增" ||
                    ...
                    || dt.Rows[i]["作业名称"].ToString() == "生产指示书"
                      || dt.Rows[i]["作业名称"].ToString() == "库存维护"
                      || dt.Rows[i]["作业名称"].ToString() == "开票维护"
                      || dt.Rows[i]["作业名称"].ToString() == "收款维护"
                    )
                {
                    r = i;
                    break;
            ...
            for (i = 0; i <dataGridView1 .Rows .Count ; i++)
            {
               // MessageBox.Show(dataGridView1["作业名称", i].Value.ToString());
                if (dataGridView1["作业名称", i].Value.ToString() == "纸品报价新增" || dataGridView1["作业名称", i].Value.ToString() == "打样单新增" ||
                    ...
                    || dataGridView1["作业名称", i].Value.ToString() == "生产指示书"
                     || dataGridView1["作业名称", i].Value.ToString() == "库存维护"
                     || dataGridView1["作业名称", i].Value.ToString() == "开票维护"
                     || dataGridView1["作业名称", i].Value.ToString() == "收款维护"
                    )
                {
                    r = i;
                    break;
        ...
        private int return_Voucher_rows_o_dgv4()
        {
            ...
            for (i = 0; i < dataGridView4.Rows.Count; i++)
            {
                ...
                if (dataGridView4["作业名称", i].Value.ToString() == "纸品报价新增" || dataGridView4["作业名称", i].Value.ToString() == "打样单新增" ||
                      ...
                      || dataGridView4["作业名称", i].Value.ToString() == "生产指示书"
                    || dataGridView4["作业名称", i].Value.ToString() == "库存维护"
                    || dataGridView4["作业名称", i].Value.ToString() == "开票维护"
                    || dataGridView4["作业名称", i].Value.ToString() == "收款维护"
                    )
                {
                    r = i;
                    break;
        ...
        private void save(DataGridView dgv)
        {
            ...
            for (int i = 0; i < dgv.Rows.Count; i++)
            {
                if (dgv["作业名称", i].Value.ToString() == "纸品报价新增" || dgv["作业名称", i].Value.ToString() == "打样单新增"
                    ...
                    || dgv["作业名称", i].Value.ToString() == "生产指示书"
                      || dgv["作业名称", i].Value.ToString() == "库存维护"
                      || dgv["作业名称", i].Value.ToString() == "开票维护"
                      || dgv["作业名称", i].Value.ToString() == "收款维护"
                    )
                {
        ...
        private void checkBox2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                    ...
                    )
                {
                    ...
                    if (dataGridView1["作业名称", i].Value.ToString() != "纸品报价新增" )
                    {
                    ...
                    if (dataGridView1["作业名称", i].Value.ToString() != "打样单新增")
                    {
        ...
        private void select_dgv4(int n)
        {
            for (int i = 0; i < dataGridView4.Rows.Count; i++)
            {
                    ...
                    )
                {
                    ...
                    if (dataGridView4["作业名称", i].Value.ToString() != "纸品报价新增")
                    {
                    ...
                    if (dataGridView4["作业名称", i].Value.ToString() != "打样单新增")
                    {
