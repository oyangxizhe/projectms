...
{
    public partial class PORTRAY : Form
    {
        ...
        {
            textBox6.Text = "17";
            dt = basec.getdts(cPORTRAY .sql );
            dt = cPORTRAY.RETURN_HAVE_ID_DT(dt);
        ...
        private void dgvStateControl()
        {
            ...
            for (i = 0; i < numCols1; i++)
            {
                ...
                dataGridView1.Columns["写真类型"].Width = 120;
        ...
        private void save()
        {
            cPORTRAY.POID  = textBox1.Text;
            cPORTRAY.PORTRAY_TYPE = textBox2.Text;
            cPORTRAY.TAX_UNIT_PRICE  = textBox3.Text;
            cPORTRAY.UNIT  = comboBox1.Text;
            cPORTRAY.TAX_MACHINE_COST  = textBox4.Text;
            cPORTRAY.TAX_RATE = textBox6.Text;
            cPORTRAY.REMARK  = textBox7.Text;
            cPORTRAY.PUT_THE_NUMBER = textBox8.Text;
            cPORTRAY.ATTRITION_RATE = textBox9.Text;
            cPORTRAY.MAKERID = LOGIN.EMID;
            cPORTRAY.CUSTOMER_TYPE = comboBox2.Text;
            cPORTRAY.save();
        ...
        private bool juage()
        {
            ...
            else if (textBox9.Text == "")
            {
                ...
                textBox6.Text != "" && bc.yesno (textBox6 .Text )==0 || bc.yesno (textBox8 .Text )==0 || bc.yesno (textBox9 .Text )==0)
            {
                b = true;
                hint.Text = "单价 费用 税率 放数 损耗率只能输入数字";
            }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                save();
                IFExecution_SUCCESS = cPORTRAY.IFExecution_SUCCESS;
                hint.Text = cPORTRAY.ErrowInfo;
        ...
        {
            dt = bc.getdt(cPORTRAY.sql + " WHERE  A.PORTRAY_TYPE LIKE '%" + textBox5.Text + "%'");
            if (dt.Rows.Count > 0)
            {
                dataGridView1.DataSource = dt;
                dgvStateControl();
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            ...
            string strSql = "DELETE FROM PORTRAY WHERE PORTRAY_TYPE='" + dt.Rows[rows]["写真类型"].ToString() + 
                "' AND CUSTOMER_TYPE='" + dt.Rows[rows]["客户类别"].ToString() + "'";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            int i=dataGridView1 .CurrentCell .RowIndex ;
                ...
                textBox1.Text = bc.getOnlyString(string.Format(@"SELECT POID FROM PORTRAY WHERE PORTRAY_TYPE='{0}' 
AND CUSTOMER_TYPE='{1}' ", dt.Rows[i]["写真类型"].ToString(), dt.Rows[i]["客户类别"].ToString()));
                textBox2.Text = dt.Rows[i]["写真类型"].ToString();
                ...
                textBox8.Text = dt.Rows[i]["放数"].ToString();
                textBox9.Text = bc.RETURN_UNTIL_CHAR (dt.Rows[i]["损耗率"].ToString(), '%');
