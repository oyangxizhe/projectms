...
{
    public partial class PRIMARY_COLORS : Form
    {
...
PRIMARY_COLORS A ";
        ...
        private void dgvStateControl()
        {
            ...
            for (i = 0; i < numCols1; i++)
            {
                ...
                dataGridView1.Columns["原色"].Width = 120;
        ...
        private void save()
        {
            ...
            if (!bc.exists("SELECT PRID FROM PRIMARY_COLORS WHERE PRID='" + textBox1 .Text + "'"))
            {

                if (bc.exists("SELECT * FROM PRIMARY_COLORS WHERE PRIMARY_COLORS='"+textBox2 .Text +"'"))
                {
                    hint.Text = "此原色已经存在";
                ...
                {
                    basec.getcoms(@"INSERT INTO PRIMARY_COLORS(PRID,PRIMARY_COLORS,MAKERID,DATE,YEAR,
            ...
            else
            {
                    ...
                    basec.getcoms(@"UPDATE PRIMARY_COLORS SET PRIMARY_COLORS='" + textBox2.Text + "',MAKERID='" + varMakerID +
                          "',DATE='" + varDate + "' WHERE PRID='" + textBox1.Text + "'");
                    IFExecution_SUCCESS = true;
                    bind();
        ...
        {
            ClearText();
            textBox1.Text = cPRIMARY_COLORS.GETID();
            textBox2.Focus();
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt = bc.getdt(sql+" WHERE  A.PRIMARY_COLORS LIKE '%"+textBox5 .Text +"%'");
                if (dt.Rows.Count > 0)
                {
                    dataGridView1.DataSource = dt;
                    dgvStateControl();
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            ...
            {
                IFExecution_SUCCESS = false;
                string strSql = "DELETE FROM PRIMARY_COLORS WHERE PRIMARY_COLORS='" + id + "'";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (v1 != "")
            {
                textBox1.Text = bc.getOnlyString(string.Format("SELECT PRID FROM PRIMARY_COLORS WHERE PRIMARY_COLORS='{0}'",v1 ));
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            OFFER_MANAGE.PRINTING_OFFERT.POSITIVE_4C = dt.Rows[index]["原色"].ToString();
