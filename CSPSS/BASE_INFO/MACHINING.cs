...
{
    public partial class MACHINING : Form
    {
        ...
        private void MACHINING_Load(object sender, EventArgs e)
        {
        ...
        {
            string sqlo = " ORDER BY B.MAID ASC";
 ...
 (SELECT USER_GROUP FROM USERINFO WHERE USID='" + LOGIN.USID + "'))" + sqlo);
        ...
        {
            //IDO = cMACHINING.GETID();
            MACHININGT FRM = new MACHININGT(this);
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            string s1 = dt.Rows[intCurrentRowNumber]["机型"].ToString();
            string s2 = dt.Rows[intCurrentRowNumber]["客户类别"].ToString();
            ...
            {
                MACHININGT FRM = new MACHININGT(this);
                FRM.IDO = bc.getOnlyString(string.Format("SELECT MAID FROM MACHINING_MST WHERE MACHINE_TYPE='{0}' AND CUSTOMER_TYPE='{1}'",s1,s2));
