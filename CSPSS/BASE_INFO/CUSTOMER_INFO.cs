...
namespace CSPSS.BASE_INFO
{
    public partial class CUSTOMER_INFO : Form
    {
        ...
        private void bind()
        {
            ...
            stb.Append(" WHERE B.PROVINCE LIKE '%" +comboBox2 .Text  + "%' ");
            stb.Append(" AND B.CNAME LIKE '%" + textBox6.Text + "%'");
            ...
            search_o(ccustomer_info.sqlsi + stb.ToString ());
 ...
 (SELECT USER_GROUP FROM USERINFO WHERE USID='" + LOGIN.USID + "'))" + sqlo);
        ...
        private void dgvStateControl()
        {
            ...
            dataGridView1.Columns["传真"].Width = 80;
            ...
            dataGridView1.Columns["传真"].ReadOnly = true;
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                if (GET_DATA_INT == 1)
                {
                    ...
                    OFFER_MANAGE.PROJECT_INFOT.CUID = s1;
                    OFFER_MANAGE.PROJECT_INFOT.CNAME = s2;
                ...
                {
                    CUSTOMER_INFOT FRM = new CUSTOMER_INFOT(this);
                    FRM.IDO = dt.Rows[dataGridView1.CurrentCell.RowIndex]["客户编号"].ToString();
