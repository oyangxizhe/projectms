...
namespace CSPSS
{
    public partial class LOGIN : Form
    {
        ...
        StringBuilder sqb = new System.Text.StringBuilder();
        ...
        {
            CURRENT_EDITION = "20190402_1240";
           
            string v5 = AppDomain.CurrentDomain.BaseDirectory;//获取应用程序之前安装的路径 16/01/10
            //MessageBox.Show(bc.GET_SQLCONNECTION_STRING());
            try
            {
               ...
               if (cuser.JUAGE_LOGIN_IF_SUCCESS(comboBox1 .Text ,textBox1 .Text ))
                {
                   ...
                   /*下面代码执行的是记住密码的操作 160127 start*/
                    ...
                    else
                    {
                        ...
                        cuser.CURRENT_EDITION = CURRENT_EDITION ;//收集客户端当前版本信息，看客户端程序有无更新到最新
