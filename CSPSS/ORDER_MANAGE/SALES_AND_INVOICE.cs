...
{
    public partial class SALES_AND_INVOICE : Form
    {
        ...
        CSALES_AND_INVOICE csales_and_invoce = new CSALES_AND_INVOICE();
        StringBuilder sqb = new StringBuilder();

        public SALES_AND_INVOICE()
        {
            InitializeComponent();
        }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SALES_AND_INVOICE));
            ...
            this.dataGridView1.Size = new System.Drawing.Size(943, 399);
            ...
            this.label4.Text = "已出货未开票查询";
            // 
            // label2
            // 
            this.label2.AutoSize = true;
            this.label2.Location = new System.Drawing.Point(655, 25);
            this.label2.Name = "label2";
            this.label2.Size = new System.Drawing.Size(101, 12);
            this.label2.TabIndex = 139;
            this.label2.Text = "已开票未出货查询";
            // 
            // label1
            // 
            ...
            this.label1.Text = "未开票未出货查询";
            // 
            // checkBox4
            // 
            this.checkBox4.AutoSize = true;
            this.checkBox4.Location = new System.Drawing.Point(616, 59);
            this.checkBox4.Name = "checkBox4";
            this.checkBox4.Size = new System.Drawing.Size(15, 14);
            this.checkBox4.TabIndex = 134;
            ...
            this.checkBox3.Location = new System.Drawing.Point(616, 26);
            ...
            this.checkBox2.Location = new System.Drawing.Point(355, 23);
            ...
            this.Name = "SALES_AND_INVOICE";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "出货及开票汇总";
            this.Load += new System.EventHandler(this.SALES_AND_INVOICE_Load);
        ...
        public void search_o(string sql)
        {
            ...
            dt = bc.getdt(sql + " ORDER BY A.ORDER_ID ASC");
            dt = csales_and_invoce.RETURN_SEARCH_DT(dt);
            if (checkBox2.Checked)
            {
                dt = bc.GET_DT_TO_DV_TO_DT(dt, "", "已开票=0 AND 已出货=0");
            }
            ...
            dt = csales_and_invoce.RETURN_HAVE_ID_DT(dt,LOGIN .EMID,LOGIN .POSITION );
        ...
        #endregion
        private void SALES_AND_INVOICE_Load(object sender, EventArgs e)
        {
            hint.Text = "";
        ...
        private void btnToExcel_Click(object sender, EventArgs e)
        {
            if (dt.Rows.Count > 0)
            {
                ...
                bc.dgvtoExcel(dataGridView1, "出货及开票信息汇总表");
            }
            else
            {
