    ...
    public partial class RECEIVABLE : Form
    {
        ...
        public  void bind()
        {
            try
            {
                ...
                dt = cRECEIVABLE.RETURN_HAVE_ID_DT(bc.getdt(sqb.ToString()), false);
                if (dt.Rows.Count > 0)
                {
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                    RECEIVABLET FRM = new RECEIVABLET(this);
...
WHERE C.ORDER_ID='" + dt.Rows[intCurrentRowNumber]["订单编号"].ToString() + "'");
        ...
        private void btnToExcel_Click(object sender, EventArgs e)
        {
            if (dt.Rows.Count > 0)
            {
                ...
                bc.dgvtoExcel(dataGridView1, "收款信息汇总表");
            }
            else
            {
        ...
        {
            ORDER_MANAGE.RECEIVABLET FRM = new RECEIVABLET();
        ...
        private void comboBox1_DropDown(object sender, EventArgs e)
        {
            ...
            sqb.Append(" GROUP BY C.ORDER_ID,E.CName,C.WNAME,C.HAVE_TAX_UNIT_PRICE, C.PRODUCTION_COUNT,B.TAX_RATE  ORDER BY C.ORDER_ID ASC");
