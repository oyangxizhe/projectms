...
namespace CSPSS.ORDER_MANAGE
{
    public partial class INVOICE : Form
    {
        ...
        public  void bind()
        {
            ...
            dt = cINVOICE.RETURN_HAVE_ID_DT(bc.getdt(sqb.ToString()), false);
            if (dt.Rows.Count > 0)
            {
        ...
        private void right()
        {
            dtx = cedit_right.RETURN_RIGHT_LIST("发票维护", LOGIN.USID);
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                    INVOICET FRM = new INVOICET(this);
...
WHERE C.ORDER_ID='" + dt.Rows[intCurrentRowNumber]["订单编号"].ToString() + "'");
        ...
        private void btnToExcel_Click(object sender, EventArgs e)
        {
            if (dt.Rows.Count > 0)
            {
                ...
                bc.dgvtoExcel(dataGridView1, "开票信息汇总表");
            }
            else
            {
        ...
        {
            ORDER_MANAGE.INVOICET FRM = new INVOICET();
        ...
        private void comboBox1_DropDown(object sender, EventArgs e)
        {
            ...
            sqb.AppendFormat(" WHERE DateDiff(day,B.INVOICE_DATE,getdate()) >-1 and DateDiff(day,B.INVOICE_DATE,getdate()) <+20");
            sqb.Append(" GROUP BY C.ORDER_ID,E.CName,C.WNAME,C.HAVE_TAX_UNIT_PRICE,B.NO_TAX_AMOUNT, C.PRODUCTION_COUNT,B.TAX_RATE  ORDER BY C.ORDER_ID ASC");
        ...
        private void btnToCSharp_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (opfv.ShowDialog() == DialogResult.OK)
                {
                    ...
                    cINVOICE.EMID = "123";
                    cINVOICE.IF_IMPORT = true;
                    cINVOICE.showdata(path);
                    if (cINVOICE.IFExecution_SUCCESS)
                    {
