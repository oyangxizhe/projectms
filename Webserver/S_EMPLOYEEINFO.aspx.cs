    ...
    public partial class S_EMPLOYEEINFO : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                 ...
                 Request.Form["ENAME"] != null)
            {
                ...
                dt = bc.getdt(cemployee_info.sql + " WHERE EMPLOYEE_ID LIKE '%" + Request.Form["EMPLOYEE_ID"].ToString() + "%' AND  ENAME LIKE '%" + Request.Form["ENAME"].ToString() + "%' AND ACTIVE!='N'");
             ...
             else if (Request.Form["POSITION"] != "" && Request.Form["POSITION"] != null)
             {
                 ...
                 dt = bc.getdt(cemployee_info.sql + " WHERE POSITION LIKE '%" + Request.Form["POSITION"].ToString() + "%' AND ACTIVE!='N'");
                 dt = cemployee_info.RETURN_HAVE_ID_DT(dt);
                 Response.Write(JsonConvert.SerializeObject(dt));
             ...
             else if (Request.Form["DEPART"] != "" && Request.Form["DEPART"] != null)
             {
                 ...
                 dt = bc.getdt(cemployee_info.sql + " WHERE DEPART LIKE '%" + Request.Form["DEPART"].ToString() + "%' AND ACTIVE!='N'");
                 dt = cemployee_info.RETURN_HAVE_ID_DT(dt);
                 Response.Write(JsonConvert.SerializeObject(dt));
            ...
            {
                dt = bc.getdt(cemployee_info.sql + " WHERE  ACTIVE!='N'");
                dt = cemployee_info.RETURN_HAVE_ID_DT(dt);
                Response.Write(JsonConvert.SerializeObject(dt));
            }
